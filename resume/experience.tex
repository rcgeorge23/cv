  ...
  \cventry
    ...
    {May 2020 - Present} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {\itshape{Java 11, Kafka, Event Sourcing, CQRS, Docker, Kubernetes, Microservices, Prometheus, Grafana}}
        \item {Contributed to the design and development of a greenfield event-sourced ledger implementation}
        \item {5th place in organisation's hackday: auto-matching customer receipts to transactions using deep learning}
      \end{cvitems}
    }
  ...
  \cventry
    ...
    {Jan 2020 - May 2020} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        \item {Worked within Bó's onboarding team to help improve the customer onboarding process by making each step in the onboarding flow idempotent and retryable}
        \item {Enhanced integration with Hooyu to improve customer feedback when identity documents are rejected}
      \end{cvitems}
    }
  ...
  \cventry
    ...
    {Jan 2018 - Dec 2019} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        \item {Migrated services from AWS to Kubernetes}
        ...
        \item {Created Intellij plugin to integrate with team's maven build process}
        \item {Created Gradle plugin to automate Gatling performance test analysis}
      \end{cvitems}
    }
  ...
  \cventry
    ...
    {Mar 2014 - Nov 2015} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        \item {Created REST API for integration with Xeus WordPress plugin}
  ...
  \cventry
    ...
    {Jul 2013 - Mar 2014} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        \item {Initiated development of a new mobile platform for Burberry, wrapping their legacy ATG implementation in a REST interface for a Backbone frontend}
  ...
  \cventry
    ...
    {Apr 2012 - Jul 2013} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        \item {Worked within a small team of developers and UX specialists to improve the usability of the Barclays Retail Online Banking system while also helping to transform development processes}
        \item {Configured Jenkins build and deployment pipeline}
        \item {Migrated from SVN to Git}
  ...
  \cventry
    ...
    {Aug 2010 - Apr 2012} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        \item {Built an extensive suite of web-based tools that allowed the Dutch ops team to administer the site}
  ...
  \cventry
    ...
    {Apr 2010 - Aug 2010} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        \item {Worked on an e-commerce implementation for Lakeland (www.lakeland.co.uk)}
        \item {Built and maintained production and disaster-recovery infrastructure}
        \item {Created deployment pipeline and managed build process}
        \item {Worked as team lead on the Debenhams web merchandising project}
      \end{cvitems}
    }
