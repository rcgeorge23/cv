  ...
  \cventry
    ...
    {May 2020 - Present} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        \item {Contributed to the design and development of a greenfield ledger implementation}
  ...
  \cventry
    ...
    {Jan 2020 - May 2020} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        \item {Worked within Bó's onboarding team to help improve the customer onboarding process.}
        \item {Made each step in the onboarding flow idempotent and retryable.}
